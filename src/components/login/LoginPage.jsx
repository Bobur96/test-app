        ...
        <div className="col-md-5 d-flex justify-content-center">
          <div className="screen">
            <div className="screen__content">
              <div className="login">
                <h6 className="h6 text-center fw-bold cl">Saytga kirish uchun parolni kiriting!</h6>
                <div className="login__field mt-4 ms-3">
                  ...
                  />
                  <span className="cr" onClick={() => setShow(!show)}>{show ? <FaEyeSlash /> : <FaEye />}</span>
                </div>
                <button disabled={loading} onClick={onSubmit} className="button login__submit">
                  <span className="button__text">Log In Now</span>
                  <i className="button__icon">{
                    loading ? <Spin /> : <FaArrowRightToBracket />}</i>
                </button>
              </div>
            </div>
